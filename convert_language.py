...
for key,value in language_data.items():
    ...
    for faq in faq_data:
        item = {}
        # temp_faq_data["Question"] = translator.translate(faq['Question'], dest=value['text_code']).text 
        # temp_faq_data["Answer"] = translator.translate(faq['Answer'], dest=value['text_code']).text 
